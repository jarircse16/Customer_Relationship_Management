...
<div class="container">
  <div class="row login-container column-seperation">
        <div class="col-md-5 col-md-offset-1">
          ...
          <p>
            <a href="registration">Sign up Now!</a> for a webarch account,It's free and always will be..</p>
          <br>
        ...
        <div class="col-md-5 "> <br>
		 ...
		 <div class="form-group col-md-10">
          ...
          <div class="control-group  col-md-10">
            <div class="checkbox checkbox check-success"> <a href="forgot-password">Forgot Password </a>&nbsp;&nbsp;
         </div>
          </div>
          </div>
          <div class="row">
